...
},
{
  ...
  issued: 1997,
  value: 0.01,
  description: "This penny features a portrait of Queen Elizabeth II designed by Canadian artist Dora dePedery-Hunt. Pennies were discontinued in May 2012.",
...
},
{
  ...
  issued: 2010,
  value: 0.05,
  description: "This nickel features the current portrait of Queen Elizabeth II, designed by Susanna Blunt in 2003. The beaver on the reverse has been featured since 1937.",
...
},
{
  ...
  issued: 1974,
  value: 0.10,
  description: "This nickel features the 1965 obverse of Queen Elizabeth II sculpted by Arnold Machin. The reverse is of the Bluenose, a renowned Candian fishing & racing vessel.",
...
},
{
  ...
  issued: 1974,
  value: 0.25,
  description: "This nickel features the 1965 obverse of Queen Elizabeth II sculpted by Arnold Machin. The reverse features a caribou, which is also one of the Quebecois nicknames for the coin.",
...
},
{
  ...
  issued: 2011,
  value: 0.01,
  description: "An Irish 1 cent euro coin. It depicts the national emblem of Ireland, an Irish harp (the Cláirseach, see Clàrsach). Vertically on the left hand side is the word 'Éire' (Ireland in the Irish language) and on the right-hand side is the date. The harp motif was designed by Jarlath Hayes.",
...
},
{
  ...
  issued: 2001,
  value: 0.05,
  description: "A Dutch 5 cent euro coin. It depicts a stylised profile of Queen Beatrix of the Netherlands surrounded by the twelve stars and other dots, with the inscription 'Beatrix Queen of The Netherlands' in Dutch around the edge. The date and mint marks are located at the bottom.",
...
},
{
  ...
  issued: 1999,
  value: 0.50,
  description: "A French 50 cent coin. It depicts	a sower in a field with a rising sun behind her. The image is taken from the previous one French franc coin designed by Louis Oscar Roty. Oscar Roty's art nouveau design reset the global trend, breaking from traditional static portraits to a full body, strident figure sowing the seeds of good fortune. For the euro coins, Jorio added hatching each side representing the French flag with the year to the left and the letters RF (République française) to the right. ",
...
},
{
  ...
  issued: 2002,
  value: 1,
  description: "A Greek 1 Euro coin. It is based on a 5th-century BC four-drachma coin from Athens. The coin is of an owl (a symbol of Athens) with an olive branch to the top left. The outline of the old coin is still shown and the value of the euro in the Greek alphabet, 1 ΕΥΡΩ, is shown on the right-hand side. The mint's mark is to the top and the date on the bottom side among the stars. ",
...
},
{
  ...
  issued: 2012,
  value: 1,
  description: "This is an older form of the 1 pound coin, predating the current 12-sided, bimetallic coin. It was part of the 2005 coin reverese design. It depics the Royal shield in its entirety.",
