...
{
  obverse:"/numismatics-img/xxx/unknown_coin_obverse.png",
  reverse:"/numismatics-img/xxx/unknown_coin_reverse.png",
  name:"Unknown coin",
  code: codes[`XXX`],
  issued: '???',
  value: '???',
  description: "I'm not actually sure where this coin is from. My best guess is that it is an older yen coin from Japan.",
  link: "https://en.wikipedia.org/wiki/Japanese_currency",
},
{
