...
export const monies = [
	{
		...
		value: 2,
		description:
			'The current design of this bill began being issued & printed in 1976. Two-dollar bills do not circulate as well as other denominations of U.S. currency. This comparative scarcity in circulation, coupled with a lack of public knowledge that the bill is still in production and circulation, has also inspired urban legends about its authenticity and value and has occasionally created problems for those trying to use the bill to make purchases.',
	...
	},
	{
		...
		value: 0.25,
		description:
			'A Washington quarter minted as part of a set of circulating commemorative coins celebrating the Bicentennial of the United States of America.',
	...
	},
	{
		...
		value: 0.25,
		description:
			"A Washington quarter minted as part of the America the Beautiful series of 2010-2021. This one for Utah's Arches National Park depicts Delicate Arch with the La Sal Mountains in the distance.",
	...
	},
	{
		...
		value: 0.25,
		description:
			"A Washington quarter minted as part of the America the Beautiful series of 2010-2021. This one for Colorado's Great Sand Dunes National Park and Preserve depicts a father and son playing on the banks of a creek, with sand dunes and the Sangre de Cristo Mountains in the background.",
		link: 'https://en.wikipedia.org/wiki/America_the_Beautiful_quarters',
	},
	{
	...
	},
	{
		...
		value: 1,
		description:
			'Part of the Series AA bank notes issued by the Bank of Mexico (and printed by the American Bank Note Company). The obverse features the Aztec sun stone, while the reverse depicts the Angel of Independence. Production of these 1-peso notes ceased in 1970.',
	...
	},
	{
		...
		value: 2,
		description:
			"The crown,or koruna, has been the currency of the Czech Republic since 1993. The crown is one of the European Union's 11 currencies, and the Czech Republic is legally bound to adopt the euro currency in the future.",
	...
	},
	{
		...
		value: 5,
		description:
			"The Deutsche Mark, abbreviated 'DM' or 'D-Mark', was the official currency of West Germany from 1948 until 1990 and later the unified Germany from 1990 until the adoption of the euro in 2002. Hamilton got this coin from a friend's father after their trip to Europe, shortly after the introduction of the euro.",
		link: '',
	},
	{
	...
	},
	{
		...
		value: 0.01,
		description:
			'This penny features a portrait of Queen Elizabeth II designed by Canadian artist Dora dePedery-Hunt. Pennies were discontinued in May 2012.',
		link: 'https://en.wikipedia.org/wiki/Penny_(Canadian_coin)',
	},
	{
		...
		value: 0.05,
		description:
			'This nickel features the current portrait of Queen Elizabeth II, designed by Susanna Blunt in 2003. The beaver on the reverse has been featured since 1937.',
		link: 'https://en.wikipedia.org/wiki/Nickel_(Canadian_coin)',
	},
	{
		...
		value: 0.1,
		description:
			'This nickel features the 1965 obverse of Queen Elizabeth II sculpted by Arnold Machin. The reverse is of the Bluenose, a renowned Candian fishing & racing vessel.',
		link: 'https://en.wikipedia.org/wiki/Dime_(Canadian_coin)',
	},
	{
		...
		value: 0.25,
		description:
			'This nickel features the 1965 obverse of Queen Elizabeth II sculpted by Arnold Machin. The reverse features a caribou, which is also one of the Quebecois nicknames for the coin.',
		link: 'https://en.wikipedia.org/wiki/Quarter_(Canadian_coin)',
	},
	{
		...
		value: 0.01,
		description:
			"An Irish 1 cent euro coin. It depicts the national emblem of Ireland, an Irish harp (the Cláirseach, see Clàrsach). Vertically on the left hand side is the word 'Éire' (Ireland in the Irish language) and on the right-hand side is the date. The harp motif was designed by Jarlath Hayes.",
		link: 'https://en.wikipedia.org/wiki/1_euro_cent_coin',
	},
	{
		...
		value: 0.05,
		description:
			"A Dutch 5 cent euro coin. It depicts a stylised profile of Queen Beatrix of the Netherlands surrounded by the twelve stars and other dots, with the inscription 'Beatrix Queen of The Netherlands' in Dutch around the edge. The date and mint marks are located at the bottom.",
		link: 'https://en.wikipedia.org/wiki/5_euro_cent_coin',
	},
	{
	...
	},
	{
		...
		value: 0.5,
		description:
			"A French 50 cent coin. It depicts	a sower in a field with a rising sun behind her. The image is taken from the previous one French franc coin designed by Louis Oscar Roty. Oscar Roty's art nouveau design reset the global trend, breaking from traditional static portraits to a full body, strident figure sowing the seeds of good fortune. For the euro coins, Jorio added hatching each side representing the French flag with the year to the left and the letters RF (République française) to the right. ",
		link: 'https://en.wikipedia.org/wiki/50_euro_cent_coin',
	},
	{
		...
		value: 1,
		description:
			"A Greek 1 Euro coin. It is based on a 5th-century BC four-drachma coin from Athens. The coin is of an owl (a symbol of Athens) with an olive branch to the top left. The outline of the old coin is still shown and the value of the euro in the Greek alphabet, 1 ΕΥΡΩ, is shown on the right-hand side. The mint's mark is to the top and the date on the bottom side among the stars. ",
		link: 'https://en.wikipedia.org/wiki/1_euro_coin',
	},
	{
		...
		link: 'https://en.wikipedia.org/wiki/Penny_(British_decimal_coin)',
	},
	{
		...
		link: 'https://en.wikipedia.org/wiki/Five_pence_(British_coin)',
	},
	{
	...
	},
	{
		...
		value: 1,
		description:
			'This is an older form of the 1 pound coin, predating the current 12-sided, bimetallic coin. It was part of the 2005 coin reverese design. It depics the Royal shield in its entirety.',
		link: 'https://en.wikipedia.org/wiki/One_pound_(British_coin)',
	},
];
