...
export const about: Blurb[] = [
    ...
    <br><br>In the beginning of 2021 Hamilton quit his job to work full time on a new programmable web platform. Although no longer working on it full time, you can find out more <a href="https://getloom.org">about Loom here</a>.
