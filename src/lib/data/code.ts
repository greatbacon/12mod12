...
export const code: Blurb[] = [
	{
		...
		I forked from where it was at in Winter of 2023 & have continued the work of building a programmable social platform. This new iteration is called Loom.`,    
		start: '2024-01-01',		
	...
	},
	{
		title: '12MOD12',
		content:
			'This website is perhaps my longest, and simultaneously most recent project as of the time of this writing.  Originally this website just served a few static HTML pages.  Over time it has grown to host most of my professional and amateur work over the last 10+ years.  As of this most recent iteration, the website is a static site built with the Sveltekit framework & Felt design library.',
		start: '2012-08-01',
