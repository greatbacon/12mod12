...
To publish a new podcast, add its filename to `manifest`.
...
const manifest: Array<Manifest> = [
  ...
  {url: '003_PlacidViews.mp3', description: `
  ...
  {url: '004_FridayNightFightClubs.mp3', description: `
  ...
  {url: '005_MonkeyBrains.mp3', description: `
  ...
  {url: '006_StageLeft.mp3', description: `
  ...
  {url: '007_HowtheWestWasOne.mp3', description: `
  ...
  {url: '008_UndertheThornbrushWillow.mp3', description: `
  ...
  {url: '009_FourAndTwenty.mp3', description: `
  ...
  {url: '010_KingoftheHobos.mp3', description: `
  ...
  {url: '011_BlueRayArchipelago.mp3', description: `
	...
	`, published: "05/25/2017"},
  {url: '012_ZooZooBabyBaby.mp3', description: `
  ...
  {url: '013_TheFidgetSpinnerMovie.mp3', description: `
  ...
  {url: '014_TapasNight.mp3', description: `
  ...
  {url: '015_TheButtonhook.mp3', description: `
  ...
  {url: '016_WearwolvesATrueStory.mp3', description: `
  ...
  {url: '017_LegendoftheLeagues.mp3', description: `
  ...
  {url: '018_VinodePayes.mp3', description: `
  ...
  {url: '019_HeightsofLove.mp3', description: `
  ...
  {url: '020_AnimalActionComicsCinematicMultiverse.mp3', description: `
  ...
  {url: '021_HisHigness.mp3', description: `
  ...
  {url: '022_UndercoverNerds.mp3', description: `
  ...
  {url: '023_StankHouse.mp3', description: `
  ...
  {url: '024_JimNotJimmy.mp3', description: `
  ...
  {url: '025_CornGod.mp3', description: `
  ...
  {url: '026_DrDespicableandtheDeceased.mp3', description: `
  ...
  {url: '027_SomeLikeItCold.mp3', description: `
  ...
  {url: '028_TheLovelyCanal.mp3', description: `
  ...
  {url: '029_AfterDarkererwithDP.mp3', description: `
  ...
  {url: '030_OceansNineEleven.mp3', description: `
...
const channel: PodcastChannel = {
	...
	albumImageURL: `${BUCKET}/HZC_smol.jpg`,
	description: 'A comedy improv podcast, here to provide all the 100% true latest news, haps, interviews, and reviews of what goes on in Hollywood, outside of it.',
	keywords: ['comedy'],
	category: 'Comedy',
	explicit: true,
};
